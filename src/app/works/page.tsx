          ...
          <Dialog>
            ...
            <DialogContent className="sm:max-w-[925px] bg-paletteText2">
              <DialogHeader>
                ...
                <DialogDescription>
                  Escape from Tarkov is a first-person shooter (FPS) video game developed by Battlestate Games. Set in a
                  post-Soviet world ravaged by war, the game puts players in the shoes of mercenaries trying to survive and escape
                  from the city of Tarkov, located in an isolated region of Russia.
                </DialogDescription>
              </DialogHeader>
              <div className="flex flex-wrap justify-center">
